...
pub const ROARING_VERSION: &[u8; 6usize] = b"0.8.0\0";
pub const ROARING_VERSION_MAJOR: _bindgen_ty_1 = 0;
pub const ROARING_VERSION_MINOR: _bindgen_ty_1 = 8;
...
#[doc = ""]
#[doc = " Should be initialized with `{0}` (or `memset()` to all zeros)."]
#[doc = " Callers should treat it as an opaque type."]
#[doc = ""]
#[doc = " A context may only be used with a single bitmap"]
#[doc = " (unless re-initialized to zero), and any modification to a bitmap"]
#[doc = " (other than modifications performed with `_bulk()` functions with the context"]
#[doc = " passed) will invalidate any contexts associated with that bitmap."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " `context` will be used to store information between calls to make bulk"]
    #[doc = " operations faster. `*context` should be zero-initialized before the first"]
    #[doc = " call to this function."]
    #[doc = ""]
    #[doc = " Modifying the bitmap in any way (other than `-bulk` suffixed functions)"]
    #[doc = " will invalidate the stored context, calling this function with a non-zero"]
    #[doc = " context after doing any modification invokes undefined behavior."]
    #[doc = ""]
    #[doc = " In order to exploit this optimization, the caller should call this function"]
    #[doc = " with values with the same \"key\" (high 16 bits of the value) consecutively."]
...
extern "C" {
    ...
    #[doc = ""]
    #[doc = " In order to exploit this optimization, the caller should attempt to keep"]
    #[doc = " values with the same \"key\" (high 16 bits of the value) as consecutive"]
    #[doc = " elements in `vals`"]
